    ...
    public static class ReportBuilderExtension
    {
        ...
        public static Report Prepare<T>(this ReportBuilder<T> reportBuilder)
        {
            ...
            foreach (var item in reportBuilder._columns)
            {
                ...
                text.Border.Lines = BorderLines.Top;
            ...
            pageFooterBand.Parent = page;
            pageFooterBand.CreateUniqueName();
            pageFooterBand.Height = Units.Centimeters * 0.5f;

            TextObject textPageNumber = new TextObject();
            textPageNumber.Parent = pageFooterBand;
            textPageNumber.CreateUniqueName();
            textPageNumber.Bounds = new RectangleF(leftCm, 0, Units.Centimeters * cellWidth * size, Units.Centimeters * 0.5f);
            textPageNumber.Text = "[PageN]";
            textPageNumber.HorzAlign = HorzAlign.Right;
            textPageNumber.TextColor = Color.Black;
            textPageNumber.Font = new Font("Arial", 10, FontStyle.Regular);
            textPageNumber.Dock = System.Windows.Forms.DockStyle.Right;

            TextObject textCopyright = new TextObject();
            textCopyright.Parent = pageFooterBand;
            textCopyright.CreateUniqueName();
            textCopyright.Bounds = new RectangleF(leftCm, 0, Units.Centimeters * cellWidth * size, Units.Centimeters * 0.5f);
            textCopyright.Text = "sysadminanywhere.com";
            textCopyright.HorzAlign = HorzAlign.Left;
            textCopyright.TextColor = Color.Black;
            textCopyright.Font = new Font("Arial", 10, FontStyle.Regular);
            textCopyright.Dock = System.Windows.Forms.DockStyle.Left;
